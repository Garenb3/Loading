...
export default function Sidebar() {
  ...
  // Sync user + photo from localStorage when another tab updates it
  useEffect(() => {
    const handleStorage = () => {
    ...
    <Link
      ...
      style={{
        ...
        backgroundColor: isActive(to)
          ? "var(--primary)"
          : accent ? "rgba(var(--primary-rgb, 229,57,53), 0.12)" : "transparent",
      ...
      onMouseLeave={(e) => {
        if (!isActive(to)) e.currentTarget.style.backgroundColor =
          accent ? "rgba(var(--primary-rgb,229,57,53),0.12)" : "transparent";
      }}
    >
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: "var(--secondary)", border: "1px solid rgba(128,128,128,0.2)",
          color: "var(--text)", cursor: "pointer", display: "flex",
          alignItems: "center", justifyContent: "center",
          boxShadow: "0 2px 12px rgba(0,0,0,0.25)", transition: "box-shadow 0.2s, transform 0.15s",
        }}
        onMouseEnter={(e) => { e.currentTarget.style.boxShadow = "0 4px 20px rgba(0,0,0,0.35)"; e.currentTarget.style.transform = "scale(1.05)"; }}
        onMouseLeave={(e) => { e.currentTarget.style.boxShadow = "0 2px 12px rgba(0,0,0,0.25)"; e.currentTarget.style.transform = "scale(1)"; }}
      >
        <MenuIcon />
      </button>
      ...
      <div
        ...
        style={{
          ...
          backdropFilter: "blur(3px)", zIndex: 1001,
      ...
      <aside
        ...
        style={{
          ...
          backgroundColor: "var(--secondary)", borderRight: "1px solid rgba(128,128,128,0.15)",
          boxShadow: "4px 0 32px rgba(0,0,0,0.3)", zIndex: 1002,
      ...
      >
        ...
        <div style={{
          ...
          padding: "20px 20px 16px", borderBottom: "1px solid rgba(128,128,128,0.12)", flexShrink: 0,
        }}>
          ...
          <button
            ...
            style={{
              background: "rgba(128,128,128,0.1)", border: "none", borderRadius: "8px",
              width: "34px", height: "34px", display: "flex", alignItems: "center",
              justifyContent: "center", color: "var(--text)", cursor: "pointer", flexShrink: 0,
            }}
          >
            <CloseIcon />
          </button>
        ...
        {/* User profile strip */}
        <div style={{
          padding: "16px 20px", borderBottom: "1px solid rgba(128,128,128,0.12)",
        ...
        {/* Bottom: theme + logout */}
        <div style={{
          padding: "12px 12px 20px", borderTop: "1px solid rgba(128,128,128,0.12)",
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: "rgba(128,128,128,0.08)", color: "var(--text)",
          ...
          {isLoggedIn && (
            <button
              ...
              style={{
                ...
                backgroundColor: "rgba(255,77,79,0.08)", color: "#ff4d4f",
