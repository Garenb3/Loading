    ...
    <div style={{ backgroundColor: "var(--bg)", color: "var(--text)", minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: "clamp(28px, 6vw, 56px)", fontWeight: "800", margin: 0, lineHeight: 1.15, letterSpacing: "-0.02em" }}>
            Track Your Favorite
            <br />
            Movies &amp; Series
          </h1>
          <p style={{ marginTop: "16px", fontSize: "clamp(14px, 2vw, 18px)", opacity: 0.85, maxWidth: "400px", marginLeft: "auto", marginRight: "auto", lineHeight: 1.6 }}>
      ...
      <section style={{ padding: "32px 24px", maxWidth: "1280px", margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px", flexWrap: "wrap", gap: "8px" }}>
          <h2 ref={featuredRef} style={{ fontSize: "22px", fontWeight: "700", margin: 0, color: "var(--text)" }}>
            ⭐ Featured
          </h2>
      ...
      <section style={{ padding: "0 24px 48px", maxWidth: "1280px", margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px", flexWrap: "wrap", gap: "8px" }}>
          <h2 ref={trendingRef} style={{ fontSize: "22px", fontWeight: "700", margin: 0, color: "var(--text)" }}>
            🔥 Trending
          </h2>
          <Link to="/listview" style={{ fontSize: "13px", color: "var(--primary)", textDecoration: "none", fontWeight: "600" }}>
            View All →
