...
export default function ListView() {
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [search, typeFilter, selectedGenres, sortBy]);
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "32px 20px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginBottom: "16px", alignItems: "center" }}>
          ...
          <div style={{ flex: 1, minWidth: "220px", position: "relative" }}>
            <span style={{
              ...
              opacity: 0.4, fontSize: "16px", pointerEvents: "none",
            }}>🔍</span>
            <input
              type="text"
              value={search}
            ...
            {search && (
              <button
                ...
                style={{
                  ...
                  opacity: 0.5, color: "var(--text)", fontSize: "16px", padding: 0,
                }}
              >✕</button>
            )}
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Type filter */}
            <p style={{ fontSize: "12px", fontWeight: "700", opacity: 0.5, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "10px", margin: "0 0 10px 0" }}>
              Type
            </p>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    color: typeFilter === value ? "#fff" : "var(--text)",
              ...
              {ALL_GENRES.map((genre) => (
                <button
                  ...
                  style={{
                    ...
                    color: selectedGenres.includes(genre) ? "#fff" : "var(--text)",
                    transition: "all 0.15s",
                  }}
                >
                  {genre}
