...
export default function ListView() {
  ...
  const activeFilterCount =
    (typeFilter !== "all" ? 1 : 0) + selectedGenres.length;
  if (loading) {
    return (
      <div
        style={{ textAlign: "center", padding: "100px", color: "var(--text)" }}
      >
  ...
  return (
    ...
    >
      ...
      >
        <h1
          style={{ fontSize: "28px", fontWeight: "800", marginBottom: "24px" }}
        >
          Movies &amp; Series
        </h1>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      typeFilter === value ? "var(--primary)" : "transparent",
